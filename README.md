...
Generated on: 2024-11-07 19:14:41
...
```javascript
const response = await axios.post(`${API_BASE}/delete`, ['id1', 'id2']);
```
...
For local development and deployment, you'll need to:

1. Create a service account in GCP console
2. Download the credentials file
3. Place it in `config/service-account.json`

**Note:** The service account credentials file is not included in the repository for security reasons. You'll need to obtain it from your GCP project.
